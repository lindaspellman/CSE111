...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    for element in symbol_quantity_list:
        ...
        partial_molar_mass = atomic_mass * quantity 
        molar_mass += partial_molar_mass
...
def main():
    ...
    mass_grams = float(input("Mass in grams: "))
    ...
    parsed_formulas = parse_formula(chem_formula, periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(parsed_formulas, periodic_table)

    # Compute the number of moles of the sample.
    number_moles = mass_grams / molar_mass
    ...
    ###
    # for table in make_periodic_table():
    #     # print(table) 
    #     # OR 
    #     # print(table.get("name")) # for example 
    #     # # I think I prefer the method way of calling the values???
        
    #     # print(type(table))
    #     print(table)

    #     # print(f"The mass is: {table.get("mass")}.") 
    #     # # could also turn mass into a variable ???
    #             #print(f"The mass is: {table["mass"]}.")
